...
function EditPostpondClass({navigation, route}: any) {
  ...
  // console.log("data?.startTime.toString()",data?.startTime.toString());
  // console.log("nextClass?.startTime.toString()",nextClass?.startTime.toLocaleTimeString([], {
  //     hour: '2-digit',
  //     minute: '2-digit',
  //   }));
  // console.log("nextClass?.startTime.toString()",nextClass?.startTime.toString());
  // console.log("nextClass?.startTime.toLocaleString().slice(10)",nextClass?.startTime.toLocaleString().slice(11));
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  <Text
                    ...
                    {nextClass?.startTime !== '-'
                      ? nextClass?.startTime.toLocaleTimeString([], {
                          hour: '2-digit',
                          minute: '2-digit',
                        })
                      : '-'}
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  <Text
                    ...
                    {nextClass?.endTime !== '-'
                      ? nextClass?.endTime.toLocaleTimeString([], {
                        hour: '2-digit',
                        minute: '2-digit',
                      })
                      : '-'}
